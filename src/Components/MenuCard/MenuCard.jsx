...
//     // Dispatch the logout event before actual logout
//     createLogoutEvent()
...
//             <button className="text-gray-500 hover:text-gray-800" aria-label="Close sidebar" onClick={onClose}>
//               <FaTimes size={20} />
//             </button>
//           </div>
...
//                 {loading ? <div className="loader-red mx-auto"></div> : "Logout"}
//               </button>
//             </div>
//           </div>
//         </div>
