  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] bg-gray-100 p-4">
      <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row w-full max-w-4xl overflow-hidden transform transition-all duration-500 hover:shadow-xl">
        ...
        <div className="md:w-1/2 flex flex-col justify-center items-center bg-gradient-to-r from-green-400 to-blue-500 text-white p-8 rounded-tl-lg rounded-bl-lg hidden md:flex">
        ...
        <div className="md:w-1/2 p-6 md:p-8 relative flex flex-col justify-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="absolute top-4 left-4 md:hidden text-gray-500 hover:text-gray-700 transition-colors"
          >
            <FaArrowLeft size={20} />
          </button>
