...
// import { FaBriefcase, FaBook } from "react-icons/fa"; // Icons for "experienced" and "fresher"
...
//           <div className="w-[40%] p-6 flex flex-col items-center justify-center h-[65vh] sticky top-20">
...
//                 <h1 className="text-3xl font-bold">Create your Naukri profile</h1>
...
//                         <h3 className="font-semibold">I'm experienced</h3>
//                       </div>
//                       <p className="text-sm text-gray-600">I have work experience (excluding internships)</p>
//                     </div>
//                     <div
...
//                     >
//                       <div className="flex items-center gap-2">
//                         <FaBook size={20} className="text-blue-500" />
//                         <h3 className="font-semibold">I'm a fresher</h3>
//                       </div>
//                       <p className="text-sm text-gray-600">I am a student / Haven't worked after graduation</p>
//                     </div>
//                   </div>
//                 </div>

//                 {/* Conditionally Render Resume Upload for Experienced Users */}
...
//                   <input type="text" placeholder="Mention the city you live in" className="w-full p-3 border rounded-lg" required />
//                 </div>
