...
//   const jobsPerPage = 4; // Adjust the number of jobs per page
...
//           className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 disabled:bg-gray-400"
//         >
//           Previous
//         </button>
