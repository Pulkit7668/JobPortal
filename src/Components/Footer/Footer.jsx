...
//       <div className="container ml-16 px-4">
//         {/* Top Section */}
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//           {/* Logo Section */}
//           <div>
//             <h2 className="text-4xl font-bold mb-4 text-blue-600">UrLogo</h2>
//             <p className="text-sm mb-3">Get real-time job updates on our app</p>
...
//               <Link to="/playstore" className="text-blue-600 hover:underline">
//                 Google Play
//               </Link>
//               <Link to="/appstore" className="text-blue-600 hover:underline">
//                 App Store
//               </Link>
//             </div>
//           </div>
