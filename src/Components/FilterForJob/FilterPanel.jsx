...
//             <h3 className="text-sm font-semibold text-gray-200 py-2">Easy Apply</h3>
//             <input
//                   type="checkbox"
//                   id="easyApply"
//                   checked={easyApply}
...
//           <div className="flex items-center justify-between mb-4 border-b border-gray-700">
//             <h3 className="text-sm font-semibold text-gray-200 py-2 ">Nearby Location</h3>
//             <input
//                   type="checkbox"
//                   id="nearbyLocation"
...
//           <div className="flex items-center justify-between mb-4 border-b border-gray-700">
//             <h3 className="text-sm font-semibold text-gray-200 py-2">Is Verified</h3>
//             <input
//                   type="checkbox"
//                   id="isVerified"
//                   checked={isVerified}
