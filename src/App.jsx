...
import DropdownCard from './Components/DropdownCard'; // Importing the DropdownCard component
...
function App() {
  ...
  const [locationQuery, setLocationQuery] = useState(""); // New state for location input
  const [filteredSuggestions, setFilteredSuggestions] = useState([]);
  const [filteredLocationSuggestions, setFilteredLocationSuggestions] = useState([]); // New state for location suggestions
    ...
    <div className="bg-blue-100 min-h-screen">
      ...
      <main className="text-center mt-16 px-4">
        ...
        <div className="mt-8 flex justify-center">
          <div className="flex bg-white shadow-xl rounded-full h-[10vh] w-[60%] items-center">
            {/* Search Icon */}
            ...
            <input
              ...
              className="flex-1 px-4 py-3 border-r border-gray-300 focus:outline-none"
            />
            ...
            <input
              ...
              className="flex px-4 py-3 ml-2 border-l border-gray-300 focus:outline-none"
            />
